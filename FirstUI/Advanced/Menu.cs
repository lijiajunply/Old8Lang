...
public class Menu : WidgetBase
{
    ...
    private void BuildMenuItems(StackPanel container, List<MenuItem> items, BuildContext context, int level)
    {
        foreach (var item in items)
        {
            ...
            if (isSelected)
            {
                itemBorder.Background = Utils.LayoutHelper.ParseColorBrush(ActiveColor);
            }
            else
            {
            ...
            if (!string.IsNullOrEmpty(item.Icon))
            {
                var icon = new TextBlock
                {
                    ...
                    Foreground = isSelected
                        ...
                        : Utils.LayoutHelper.ParseColorBrush("#666666")
                };
            ...
            var titleText = new TextBlock
            {
                ...
                Foreground = isSelected
                    ? Utils.LayoutHelper.ParseColorBrush("#FFFFFF")
                    : Utils.LayoutHelper.ParseColorBrush("#333333")
            };
