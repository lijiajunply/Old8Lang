...
/// <summary>
/// List.Except 方法 - 返回第一个列表中不在第二个列表中的元素
/// </summary>
public class ListExceptMethod : BaseInstanceMethod
{
        ...
        VariateManager manager, SourcePosition position)
    {
        ...
        {
            throw new TypeError(position, $"Except 方法的参数必须是列表类型，但实际是 {otherValue.GetType().Name}");
        }
        ...
        ILGenerator ilGenerator, LocalManager local, SourcePosition position)
    {
        ...
        // 调用辅助方法
        var helperMethod = typeof(ListExceptMethod).GetMethod(nameof(ExceptHelper),
    ...
    /// 辅助方法：差集操作
    /// </summary>
    public static ListLangValue ExceptHelper(ListLangValue list, ListLangValue other)
    {
        var result = new List<LangValueType>();
    ...
    protected override object? ExecuteInVMInternal(object? instance, object?[] arguments)
    {
        ...
        {
            return list.Except(other).ToList();
        }
