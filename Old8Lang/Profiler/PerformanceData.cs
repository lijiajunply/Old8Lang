...
public class FunctionPerformanceStats
{
    ...
    {
        return
            $"{FunctionName}: {CallCount} calls, avg {AverageExecutionTimeMs:F2}ms, total {TotalExecutionTimeMs:F2}ms";
    }
}
...
public class MemoryUsageStats
{
    ...
    {
        return
            $"Memory: {ManagedMemoryMb:F2}MB managed, {UnmanagedMemoryMb:F2}MB unmanaged, GC: {TotalGcCollections} times";
    }
}
...
public class ProfilingSession
{
    ...
    public void RecordFunctionExecution(string functionName, double executionTimeMs, string? sourceFile = null,
        int? lineNumber = null)
    {
