...
/// 文档格式化处理器 - 提供代码格式化功能
/// </summary>
public class DocumentFormattingHandler(DocumentManager documentManager, FormattingService formattingService)
    : IDocumentFormattingHandler, IDocumentRangeFormattingHandler
{
    ...
    public Task<TextEditContainer?> Handle(DocumentFormattingParams request, CancellationToken cancellationToken)
    {
        ...
        var edits = formattingService.FormatDocument(document.Text, request.Options);
    ...
    public Task<TextEditContainer?> Handle(DocumentRangeFormattingParams request, CancellationToken cancellationToken)
    {
        ...
        var edits = formattingService.FormatRange(document.Text, request.Range, request.Options);
