    ...
    : ParserBase(context)
{
    ...
    public LangExpression ParseBinaryExpression()
    {
        ...
        while (CurrentToken.Type is LangTokenType.In or LangTokenType.Is or LangTokenType.IsNot or LangTokenType.LessThanEquals or LangTokenType.GreaterThanEquals
