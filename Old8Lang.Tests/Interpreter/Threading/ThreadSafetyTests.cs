...
public class ThreadSafetyTests : InterpreterTestBase
{
    public ThreadSafetyTests(ITestOutputHelper output) : base(output)
    {
    }
    ...
    [Fact]
    public void ThreadSafe AsyncOperation_AsyncThreadSafety()
    {
        var code = @"
            // 异步操作的线程安全
