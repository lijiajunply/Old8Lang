...
result <- a * 2";
        ...
        Assert.Equal(246, ((IntLangValue)result).Value);
    }
...
result <- name + "" Program""";
        ...
        Assert.Equal("Test Program", ((StringLangValue)result).Value);
    }
...
result <- value * 2";
        ...
        var result = interpreter.Manager.GetValue(new LangId("result"));
        Assert.IsType<IntLangValue>(result);
        Assert.Equal(84, ((IntLangValue)result).Value);
    }
...
result <- a * b";
        ...
        // Assert
        var result = interpreter.Manager.GetValue(new LangId("result"));
        Assert.Equal(56, ((IntLangValue)result).Value);
    }
