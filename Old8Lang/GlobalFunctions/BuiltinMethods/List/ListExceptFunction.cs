...
/// <summary>
/// List.Except(otherList) - 返回两个列表的差集
/// </summary>
/// <remarks>
/// 用法: list.Except(otherList)
/// 返回: 包含当前列表中有但另一个列表中没有的元素的新列表
/// </remarks>
public sealed class ListExceptFunction : BaseGlobalFunction
{
    public override string[] Names => ["List.Except"];
        ...
        SourcePosition position)
    {
        ...
        // 遍历第一个列表，添加差集元素
        GenerateExceptLoop(ilGenerator, list1Local, resultLocal, otherSetLocal, seenLocal);
    ...
    private static void GenerateExceptLoop(
        ILGenerator ilGenerator,
        LocalBuilder listLocal,
