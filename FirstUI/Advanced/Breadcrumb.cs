    ...
    public override object Build(BuildContext context)
    {
        ...
        for (int i = 0; i < Items.Count; i++)
        {
            ...
            var textBlock = new TextBlock
            {
                ...
                Foreground = isLast
                    ? Utils.LayoutHelper.ParseColorBrush(ActiveColor)
                    : Utils.LayoutHelper.ParseColorBrush(TextColor)
            };
            ...
            if (!isLast || item.IsClickable)
            {
                ...
                {
                    textBlock.Foreground = Utils.LayoutHelper.ParseColorBrush(HoverColor);
