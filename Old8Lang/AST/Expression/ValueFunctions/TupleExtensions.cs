...
public static class TupleExtensions
{
    ...
    /// 切片操作
    /// </summary>
    public static object Slice(this ITuple tuple, int start, int end)
    {
    ...
    /// 转换为字符串
    /// </summary>
    public static string ToStr(this ITuple tuple)
    {
    ...
    /// 连接为字符串
    /// </summary>
    public static string Join(this ITuple tuple, string separator)
    {
        var items = new List<string>();
        for (int i = 0; i < tuple.Length; i++)
        {
    ...
    /// 包含检查
    /// </summary>
    public static bool Contains(this ITuple tuple, object? item)
    {
        for (int i = 0; i < tuple.Length; i++)
        {
    ...
    /// 反转元组
    /// </summary>
    public static object Reverse(this ITuple tuple)
    {
    ...
    /// 连接两个元组
    /// </summary>
    public static object Concat(this ITuple tuple, ITuple other)
    {
