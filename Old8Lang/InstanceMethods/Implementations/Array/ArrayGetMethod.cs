...
/// <summary>
/// Array.Get(index) - 获取数组元素
/// </summary>
public class ArrayGetMethod : BaseInstanceMethod
{
        ...
        ILGenerator ilGenerator, LocalManager local, SourcePosition position)
    {
        ...
        var helperMethod = typeof(ArrayGetMethod).GetMethod(nameof(GetHelper),
            System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Static);
        ilGenerator.Emit(OpCodes.Call, helperMethod!);
    }

    public static object? GetHelper(object[] array, object indexObj)
    {
