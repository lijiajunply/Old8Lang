...
/// <summary>
/// List.LastOrDefault() - 获取列表的最后一个元素，如果列表为空则返回 null
/// </summary>
/// <remarks>
/// 用法: list.LastOrDefault()
/// 返回: 列表的最后一个元素或 null
/// </remarks>
public sealed class ListLastOrDefaultFunction : BaseGlobalFunction
{
    public override string[] Names => ["List.LastOrDefault"];
        ...
        SourcePosition position)
    {
        ...
        return list.Values.Count == 0 ? new NullLangValue() : list.Values[^1];
    }
