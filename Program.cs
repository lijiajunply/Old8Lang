...
";
        ...
        {
            BlockStatement ast = _interpreter.Build(_simpleCode);
            Action compiledAction = Compiler.Compile(ast, "simple_test", _interpreter);
            compiledAction();
        }
        ...
        {
            BlockStatement ast = _interpreter.Build(_mediumCode);
            Action compiledAction = Compiler.Compile(ast, "medium_test", _interpreter);
            compiledAction();
        }
        ...
        {
            BlockStatement ast = _interpreter.Build(_complexCode);
            Action compiledAction = Compiler.Compile(ast, "complex_test", _interpreter);
            compiledAction();
        }
        ...
        public void GenerateILSimpleCode()
        {
            ...
            // 测量IL生成时间
            Action compiledAction = Compiler.Compile(ast, "simple_il_test", _interpreter);
        }
        ...
        public void GenerateILMediumCode()
        {
            ...
            // 测量IL生成时间
            Action compiledAction = Compiler.Compile(ast, "medium_il_test", _interpreter);
        }
        ...
        public void GenerateILComplexCode()
        {
            ...
            // 测量IL生成时间
            Action compiledAction = Compiler.Compile(ast, "complex_il_test", _interpreter);
        }
        ...
        public void ExecuteCompiledSimpleCode()
        {
            // 预编译代码
            BlockStatement ast = _interpreter.Build(_simpleCode);
            Action compiledAction = Compiler.Compile(ast, "simple_execute_test", _interpreter);
        ...
        public void ExecuteCompiledComplexCode()
        {
            // 预编译代码
            BlockStatement ast = _interpreter.Build(_complexCode);
            Action compiledAction = Compiler.Compile(ast, "complex_execute_test", _interpreter);
        ...
        public void MultipleCompilations()
        {
            ...
            {
                BlockStatement ast = _interpreter.Build(_simpleCode);
                Action compiledAction = Compiler.Compile(ast, "multiple_test", _interpreter);
                compiledAction();
            }
        }
        ...
        public void ILVerificationOverhead()
        {
            ...
            BlockStatement ast = _interpreter.Build(_mediumCode);
            Action compiledAction = Compiler.Compile(ast, "il_verification_test", _interpreter);
            compiledAction();
        }
        ...
        public void NoILVerification()
        {
            ...
            BlockStatement ast = _interpreter.Build(_mediumCode);
            Action compiledAction = Compiler.Compile(ast, "no_il_verification_test", _interpreter);
            compiledAction();
    ...
    /// </summary>
    [Config(typeof(InterpreterBenchmarkConfig))]
    public class InterpreterBenchmarkTests
    {
        ...
        /// 基准测试配置
        /// </summary>
        private class InterpreterBenchmarkConfig : ManualConfig
        {
            public InterpreterBenchmarkConfig()
            {
                AddJob(Job.Default
                    .WithWarmupCount(3)
                    .WithIterationCount(10)
...
";
        ...
        {
            BlockStatement ast = _interpreter.Build(_loopIntensiveCode);
            ast.Run(_interpreter.Manager);
        }
        ...
        {
            BlockStatement ast = _interpreter.Build(_functionCallIntensiveCode);
            ast.Run(_interpreter.Manager);
        }
        ...
        {
            BlockStatement ast = _interpreter.Build(_mixedIntensiveCode);
            ast.Run(_interpreter.Manager);
        }
...
";
            BlockStatement ast = _interpreter.Build(recursionCode);
            ast.Run(_interpreter.Manager);
        }
...
result <- while_test()
";
            BlockStatement ast = _interpreter.Build(whileCode);
            ast.Run(_interpreter.Manager);
        }
    }
    ...
    class Program
    {
        ...
        {
            Console.WriteLine("Running Old8Lang