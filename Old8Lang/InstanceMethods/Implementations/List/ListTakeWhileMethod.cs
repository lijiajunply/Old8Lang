...
/// <summary>
/// List.TakeWhile(predicate) - 从列表开头获取元素，直到不满足条件
/// </summary>
public class ListTakeWhileMethod : BaseInstanceMethod
{
    public override string[] Names => ["TakeWhile", "takeWhile"];
    ...
    {
        throw new NotSupportedException("List.TakeWhile 方法暂不支持编译模式");
    }
