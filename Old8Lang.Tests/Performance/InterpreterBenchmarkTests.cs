...
";
    ...
    {
        var ast = _interpreter.Build(_loopIntensiveCode);
    ...
    {
        var ast = _interpreter.Build(_functionCallIntensiveCode);
        ast.Run(_interpreter.Manager);
    }
    ...
    {
        var ast = _interpreter.Build(_mixedIntensiveCode);
        ast.Run(_interpreter.Manager);
    }
...
";
        var ast = _interpreter.Build(recursionCode);
        ast.Run(_interpreter.Manager);
    }
...
result <- while_test()
";
        var ast = _interpreter.Build(whileCode);
        ast.Run(_interpreter.Manager);
    }
}