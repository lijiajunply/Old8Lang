...
/// <summary>
/// List.Union 方法 - 返回两个列表的并集（去重）
/// </summary>
public class ListUnionMethod : BaseInstanceMethod
{
        ...
        VariateManager manager, SourcePosition position)
    {
        ...
        {
            throw new TypeError(position, $"Union 方法的参数必须是列表类型，但实际是 {otherValue.GetType().Name}");
        }
        ...
        ILGenerator ilGenerator, LocalManager local, SourcePosition position)
    {
        ...
        // 调用辅助方法
        var helperMethod = typeof(ListUnionMethod).GetMethod(nameof(UnionHelper),
    ...
    /// 辅助方法：并集操作
    /// </summary>
    public static ListLangValue UnionHelper(ListLangValue list, ListLangValue other)
    {
        var result = new List<LangValueType>();
    ...
    protected override object? ExecuteInVMInternal(object? instance, object?[] arguments)
    {
        ...
        {
            return list.Union(other).ToList();
        }
