...
public class TypeConversionTests
{
    ...
    public void RoundTrip_Dictionary_MaintainsStructure()
    {
        ...
        if (langValue is DictionaryLangValue dictVal)
        {
            ...
            {
                var key = tuple.V1 is LangValueType kvt ? kvt : LangValueType.ObjToValue(tuple.V1);
                var value = tuple.V2 is LangValueType vvt ? vvt : LangValueType.ObjToValue(tuple.V2);
