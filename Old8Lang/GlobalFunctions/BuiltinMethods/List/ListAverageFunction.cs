...
/// 异常: 当列表为空或包含非数值元素时抛出
/// </remarks>
public sealed class ListAverageFunction : BaseGlobalFunction
{
    public override string[] Names => ["List.Average"];
        ...
        SourcePosition position)
    {
        ...
        {
            throw new InvalidOperationError(list, "无法对空列表求平均值");
        }
        ...
        foreach (var item in list.Values)
        {
            switch (item)
            {
                ...
                case DoubleLangValue doubleVal:
                    ...
                    break;
                default:
                    throw new InvalidOperationError(list, $"无法对非数值类型 {item.TypeToString()} 求平均值");
            }
        }
        ...
        foreach (var item in list)
        {
            switch (item)
            {
                ...
                case double doubleVal:
                    ...
                    break;
                default:
                    throw new InvalidOperationException($"无法对非数值类型求平均值");
            }
        }
