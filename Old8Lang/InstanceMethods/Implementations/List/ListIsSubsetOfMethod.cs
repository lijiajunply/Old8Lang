...
/// <summary>
/// List.IsSubsetOf(other) - 检查当前列表是否为另一个列表的子集
/// </summary>
public class ListIsSubsetOfMethod : BaseInstanceMethod
{
    public override string[] Names => ["IsSubsetOf", "isSubsetOf"];
        ...
        VariateManager manager, SourcePosition position)
    {
        ...
        // 检查 list 中的每个元素是否都在 otherList 中
        ...
        ILGenerator ilGenerator, LocalManager local, SourcePosition position)
    {
        ...
        var helperMethod = typeof(ListIsSubsetOfMethod).GetMethod(nameof(IsSubsetOfHelper),
            System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Static);
        ilGenerator.Emit(OpCodes.Call, helperMethod!);
    }

    public static bool IsSubsetOfHelper(List<object?> list, List<object?> other)
    {
        // 检查 list 中的每个元素是否都在 other 中
    ...
    protected override object? ExecuteInVMInternal(object? instance, object?[] arguments)
    {
        if (instance is List<object?> list && arguments.Length > 0)
        {
            ...
            return IsSubsetOfHelper(list, other);
        }
