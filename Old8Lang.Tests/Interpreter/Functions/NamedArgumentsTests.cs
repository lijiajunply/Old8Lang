...
public class NamedArgumentsTests
{
    ...
    public void NamedArguments_AllNamed_ExecutesCorrectly()
    {
        ...
        Assert.Equal("Hi, Bob! Age: 30", result.Value);
    }
    ...
    public void NamedArguments_MixedWithPositional_ExecutesCorrectly()
    {
        ...
        var result = interpreter.Manager.GetValue(new LangId("result")) as StringLangValue;
        Assert.NotNull(result);
        Assert.Equal("Good morning, Charlie! Age: 35", result.Value);
    }
    ...
    public void NamedArguments_WithDefaultParameters_SkipsSomeArgs_ExecutesCorrectly()
    {
        ...
        var result = interpreter.Manager.GetValue(new LangId("result")) as StringLangValue;
        Assert.NotNull(result);
        Assert.Equal("Window: 800x1080", result.Value);
    }
    ...
    public void NamedArguments_WithDefaultParameters_OverridesAll_ExecutesCorrectly()
    {
        ...
        var result = interpreter.Manager.GetValue(new LangId("result")) as StringLangValue;
        Assert.NotNull(result);
        Assert.Equal("HD Window: 1280x720", result.Value);
    }
    ...
    public void NamedArguments_WithExpressionValues_ExecutesCorrectly()
    {
        ...
        var result = interpreter.Manager.GetValue(new LangId("result")) as IntLangValue;
        Assert.NotNull(result);
        Assert.Equal(45, result.Value); // (10 + 5) + (5 * 2) * 3 = 15 + 30 = 45
    }
    ...
    public void NamedArguments_WithFunctionCallValues_ExecutesCorrectly()
    {
        ...
        var result = interpreter.Manager.GetValue(new LangId("result")) as IntLangValue;
        Assert.NotNull(result);
        Assert.Equal(30, result.Value); // double(5) + double(10) = 10 + 20 = 30
    }
    ...
    public void NamedArguments_BooleanParameters_ExecutesCorrectly()
    {
        ...
        Assert.Equal("all true", result1.Value);
        Assert.Equal("some true", result2.Value);
        Assert.Equal("all false", result3.Value);
    }
    ...
    public void NamedArguments_DoubleParameters_ExecutesCorrectly()
    {
        ...
        // Assert
        var result = interpreter.Manager.GetValue(new LangId("result")) as DoubleLangValue;
        Assert.NotNull(result);
        Assert.Equal(9.0, result.Value); // 2.5 * 3.0 + 1.5 = 7.5 + 1.5 = 9.0
    }
    ...
    public void NamedArguments_RecursiveFunction_ExecutesCorrectly()
    {
        ...
        var result = interpreter.Manager.GetValue(new LangId("result")) as IntLangValue;
        Assert.NotNull(result);
        Assert.Equal(8, result.Value); // 2^3 = 8
    }
    ...
    public void NamedArguments_ManyParameters_ExecutesCorrectly()
    {
        ...
        var result = interpreter.Manager.GetValue(new LangId("result")) as IntLangValue;
        Assert.NotNull(result);
        Assert.Equal(15, result.Value); // 1 + 2 + 3 + 4 + 5 = 15
    }
    ...
    public void NamedArguments_ComplexNestedCalls_ExecutesCorrectly()
    {
        ...
        var result = interpreter.Manager.GetValue(new LangId("result")) as IntLangValue;
        Assert.NotNull(result);
        Assert.Equal(16, result.Value); // add(multiply(2, 3), 10) = add(6, 10) = 16
    }
