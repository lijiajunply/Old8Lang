...
public partial class ArrayLangValue : LangValueType, ILangList
{
    ...
    public override LangValueType Dot(LangExpression dotExpression, VariateManager manager)
    {
        ...
        if (dotExpression is Instance instance)
        {
            ...
            var knownMethods = new[] { "Count", "Sort", "QuickSort", "MergeSort", "BubbleSort", "SelectionSort", "InsertionSort", "HeapSort", "IsSorted", "Distinct", "Map", "Filter", "Reduce", "Get", "Set", "Length", "ToList" };
